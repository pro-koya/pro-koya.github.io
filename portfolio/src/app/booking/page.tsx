      ...
      <main>
        <section className="sec-hero">
          ...
          <p className="contact-page-desc" style={{ marginTop: 16 }}>
            まずは文章で伝えたい・軽く聞いてみたい場合は、<a href="/members/koya/portfolio/contact/" style={{ textDecoration: 'underline' }}>お問い合わせ</a> からでも受け付けています。
          </p>
        </section>
            ...
            <div className="reveal">
              ...
              {loadState === 'error' && (
                <p className="booking-hint">
                  ...
                  <a href="/members/koya/portfolio/contact/" style={{ textDecoration: 'underline' }}>お問い合わせ</a>からご連絡ください。
                </p>
              )}
              {loadState === 'empty' && (
                <p className="booking-hint">
