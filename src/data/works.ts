...
const ALL_WORKS: readonly Work[] = [
  ...
  },
  {
    ...
    en: 'DOGWALK',
    tag: 'PET · APP',
    description: '毎日の散歩を、愛犬の健康記録に変えるアプリ。',
    body: 'GPSでルートと距離を記録し、うんちの状態や水分まで散歩しながらワンタップで残せる。続けるほど、獣医さんに見せられる90日分の健康レポートになる「犬版Strava」を目指した自社プロダクトです。',
    year: '2026',
    no: '07',
    detailPath: '/case-studies/dogwalk-app/',
    category: 'ios',
    kind: 'personal',
    variant: 'green',
    categoryLabel: 'iOS App',
    focusLabel: '散歩記録 / 健康ログ / 獣医共有',
    summary: '散歩を健康記録に変える、犬の散歩アプリ',
    excerpt: 'GPSルート記録、健康ログ、暑さ指数、獣医共有レポートまでを備えたiOSアプリです。',
    tags: ['Flutter', 'Drift (SQLite)', 'GPSルート記録', '健康ログ'],
    thumbnail: '/assets/media/dogwalk/shot-home.png',
  },
  {
